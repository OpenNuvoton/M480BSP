...
void spim_routine(void)
{
    ...
    spim_put_string("+----------------------------------------------------------------+\n");
    spim_put_string("|    DPD Power-down Mode and Wake-up Sample Code.                |\n");
    spim_put_string("|    Please Select Wake up source.                               |\n");
    spim_put_string("+----------------------------------------------------------------+\n");
    spim_put_string("|[1] DPD Wake-up Pin(PC.0) trigger type is rising edge.          |\n");
    spim_put_string("|[2] DPD Wake-up TIMER time-out interval is 16384 OSC10K clocks. |\n");
    spim_put_string("+----------------------------------------------------------------+\n");
