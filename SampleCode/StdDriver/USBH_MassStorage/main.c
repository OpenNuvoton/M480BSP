 ...
 * @file     main.c
 * @version  V1.00
 * @brief    This sample uses a command-shell-like interface to demonstrate how to use USBH
 *           mass storage driver and make it working as a disk driver under FATFS file system.
 *
 *
