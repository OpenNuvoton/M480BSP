...
void SYS_Init(void)
{
    ...
    SYS->GPG_MFPH = (SYS->GPG_MFPH & ~SYS_GPG_MFPH_PG9MFP_Msk) | SYS_GPG_MFPH_PG9MFP_CCAP_PCLK;
    SYS->GPG_MFPH = (SYS->GPG_MFPH & ~SYS_GPG_MFPH_PG10MFP_Msk)| SYS_GPG_MFPH_PG10MFP_CCAP_CLKO;
    ...
    SYS->GPB_MFPH = (SYS->GPB_MFPH & ~SYS_GPB_MFPH_PB13MFP_Msk)| SYS_GPB_MFPH_PB13MFP_CCAP_PCLK;
    SYS->GPB_MFPH = (SYS->GPB_MFPH & ~SYS_GPB_MFPH_PB12MFP_Msk)| SYS_GPB_MFPH_PB12MFP_CCAP_CLKO;
