...
typedef void (INT_CB_FUNC)(int status, uint8_t *rdata, int data_len);
...
extern int  lbk_device_connected(void);
...
extern int  lbk_interrupt_out(uint8_t *data_buff, int data_len, int timeout_ticks);
