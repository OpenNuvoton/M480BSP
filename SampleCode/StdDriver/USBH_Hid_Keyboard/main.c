 ...
 * @file     main.c
 * @version  V1.00
 * @brief    This sample includes an USB keyboard driver which based on HID driver.
 *           It demonstrates reading key inputs from USB keyboards.
 *
 *
...
int32_t main(void)
{
    ...
    printf("+--------------------------------------------+\n");
    printf("|                                            |\n");
    printf("|     USB Host HID keyboard sample demo      |\n");
    printf("|                                            |\n");
    printf("+--------------------------------------------+\n");
