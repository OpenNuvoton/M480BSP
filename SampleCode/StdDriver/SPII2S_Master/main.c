 ...
 * @version  V0.10
 * @brief
 *           Configure SPI2 as I2S Master mode and demonstrate how I2S works in Master mode.
...
int32_t main(void)
{
    ...
    SPII2S_Open(SPI2, I2S_MODE_MASTER, 16000, I2S_DATABIT_16, SPII2S_STEREO, I2S_FORMAT_I2S);
